...
class ProductRepository extends GetxController {
  ...
  Future<void> updateProduct(ProductModel product) async {
    try {
      ...
      Get.snackbar("Cập nhật thành công", "Sản phẩm đã được cập nhật",
  ...
  Future<void> addVariant(
      ProductModel parentProduct, ProductModel variant) async {
    ...
    try {
      DocumentReference docRef =
          await _db.collection("products").add(variant.toJson());
      ...
      Get.snackbar("Thành công", "Thêm biến thể thành công",
          backgroundColor: Colors.green, colorText: Colors.white);
    } catch (error) {
      _handleError(error);
    }
